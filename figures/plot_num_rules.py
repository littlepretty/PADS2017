...
fig, ax = plt.subplots()
ax.bar(scale_tree, tree_rules, width, color='red', hatch='/',
       label='Tree Network')
ax.bar(scale_bs, bs_rules, width, color='blue', hatch='\\',
...
plt.xlabel('Tree-Topology Settings')
plt.ylabel('Total #Rules in Network')
