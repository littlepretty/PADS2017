...
\hl{We then create a graph model representing the forwarding behavior of each EC. By traversing those graphs we finally construct the rules on the big-switch model that preserve the original network's end-to-end forwarding effects.}
