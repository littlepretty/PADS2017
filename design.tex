...
Taken a snapshot of SDN network as input, BigSim transform it to a single ``big"
OpenFlow switch that preserve the forwarding logic of the original network.
